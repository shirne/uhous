        ...
        return this.each(function() {
            ...
            if (option.generatePagination) {
                ...
                control.children().each(function() {
                    $('.' + option.paginationClass, elem).append('<span><a href="#' + number + '">' + (number + 1) + '</a></span>');
                    number++;
                });
            } else {
                $('.' + option.paginationClass + ' span a', elem).each(function() {
                    $(this).attr('href', '#' + number);
                    number++;
                });
            }
            $('.' + option.paginationClass + ' span:eq(' + start + ')', elem).addClass('current');
            ...
            function animate(direction, effect, clicked) {
                if (!active && loaded) {
                    ...
                    case 'pagination':
                        ...
                        prev = $('.' + option.paginationClass + ' span.current a', elem).attr('href').match('[^#/]+$');
                        if (next > prev) {
                            position = width * 2;
                            direction = -width * 2;
                        } else {
                    ...
                    if (option.pagination) {
                        ...
                        $('.' + option.paginationClass + ' span:eq(' + next + ')', elem).addClass('current');
                    }
                }
            };
        });
