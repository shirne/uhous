...
function initInput(i, v){v=v||$(i).val();$(i).focus(function(){if(this.value==v)this.value='';}).blur(function(){if(this.value=='')this.value=v;});$($(i)[0].form).submit(function(){if($(i).val()==v)$(i).val('');})}
$.extend($.fn,{
        Tips:function(opt){
            var st=$.extend({
