                ...
                <table class="table-data">
                    <thead>
                        <tr>
                            ...
                            <th width="25%">服务项名称</th>
                            <th width="20%">服务项图片</th>
                            <th width="10%">创建日期</th>
                            <th>管理</th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="7">
{{ webcontrol type='Pagenav' name='pager' pager=$pager prevLabel='上一页' nextLabel='下一页' controller=$controller action=$action colkey=$colkey lang=$lang search=$search cate_id=$cate_id merc_id=$merc_id}}
                            </th>
                        </tr>
                    </tfoot>
                    <tbody>
