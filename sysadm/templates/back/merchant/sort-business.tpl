...
{{ webcontrol type='Position' name='position' column='栏目管理' position='行业排序' footprint='yes' }}
...
<script type="text/javascript" src="/sysadm/js/sortselect.js"></script>
    ...
    <div class="layout clearfix mt">
        ...
        <form id="sortform" name="sortform" action="{{ url controller='Merchant' action='SaveSortBusiness' }}" method="post">
            ...
            <div class="layout-left">
                ...
                <div class="box">
                    ...
                    <div class="form">
                        ...
                        {{ section name=business loop=$businesses }}
                            <option value="{{ $businesses[business].business_id}}">{{ $smarty.section.business.iteration }}.{{ $businesses[business].name}}</option>
                        {{ /section }}
                        </select>
                    </div>
                </div>
