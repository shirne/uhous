...
<script type="text/javascript" src="/sysadm/js/sortselect.js"></script>
    ...
    <div class="layout clearfix mt">
        ...
        <form id="sortform" name="sortform" action="{{ url controller='Merchant' action='SaveSortCategories' }}" method="post">
            ...
            <div class="layout-left">
                ...
                <div class="box">
                    <h3>分类</h3>
                    <div class="form">
                        <select id="sort" name="sort" size="26" style="width:100%" ondblclick="window.location.href='{{ url controller="Merchant" action="SortCategories" }}&parent_id=' + $('#sort option:selected').val()">
...
{{ /foreach }}
                            ...
                            onclick="window.location.href='{{ url controller="Merchant" action="SortCategories" }}&parent_id=' + $('#parent_id option:selected').val()" />
                        </p>
