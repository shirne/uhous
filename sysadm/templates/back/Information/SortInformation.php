 ...
 * @version    $Id: SortInformation.php 2 2010-04-27 16:47:43Z allen $
 **/
?>
...
// 载入当前位置页面控件
getControl('Position', 'position', array('position' => '信息排序', 'column' => '栏目管理', 'footprint' => true));
    ...
    <div class="layout clearfix mt">
        ...
        <form id="sortform" name="sortform" action="<?php echo _url(currentController(), 'SaveSort'); ?>" method="post">
            ...
            <div class="layout-left">
                ...
                <div class="box">
                    <h3><?php echo $data['column']['name']; ?> &rsaquo; 信息</h3>
                    <div class="form">
                        <select id="sort" name="sort" size="30" style="width:100%">
                        <?php if ($data['rows']): ?>

                        <?php foreach ($data['rows'] as $i => $row): ?>
                            <option value="<?php echo $row['info_id']; ?>"><?php echo $i+1 . '.' . $row['title']; ?></option>
                        <?php endforeach; ?>
            ...
            <div class="layout-right">
                ...
                <div class="box">
                    ...
                    <div class="form">
                        ...
                        <p>
                        	<label for="cate_id">选择信息所属分类</label>
                            ...
                            <input class="ibtn" type="button" value="列出信息" 
