...
{{ webcontrol type='Position' name='position' column='栏目管理' position='留言搜索' footprint='yes' }}

{{ assign var='cmdType' value='message' }}
...
<div class="layout clearfix">
        ...
        <div class="box">
            ...
            <div class="form">
                ...
                <form id="editform" name="editform" action="{{ url controller='Guestbook' search='yes' }}" method="post">
                    <table>
                        <tr>
                            <td>
                                <p>
