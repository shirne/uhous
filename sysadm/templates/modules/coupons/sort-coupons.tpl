...
{{ webcontrol type='Position' name='position' column='栏目管理' position='优惠券排序' footprint='yes' }}
...
<script type="text/javascript" src="/sysadm/js/sortselect.js"></script>
    ...
    <div class="layout clearfix mt">
        ...
        <form id="sortform" name="sortform" action="{{ url controller='Coupons' action='SaveSort' }}" method="post">
            ...
            <div class="layout-left">
                ...
                <div class="box">
                    ...
                    <div class="form">
                        ...
                        {{ section name=coupon loop=$coupons }}
                            <option value="{{ $coupons[coupon].cou_id}}">{{ $smarty.section.coupon.iteration }}.{{ $coupons[coupon].name}}</option>
                        {{ /section }}
                        </select>
                    </div>
                </div>
