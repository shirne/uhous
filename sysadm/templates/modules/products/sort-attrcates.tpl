...
{{ webcontrol type='Position' name='position' column='栏目管理' position='属性项排序' footprint='yes' }}
...
<script type="text/javascript" src="/sysadm/js/sortselect.js"></script>
    ...
    <div class="layout clearfix mt">
        ...
        <form id="sortform" name="sortform" action="{{ url controller='Products' action='SaveSortAttrCates' }}" method="post">
            ...
            <div class="layout-left">
                ...
                <div class="box">
                    <h3>属性项</h3>
                    <div class="form">
                        <select id="sort" name="sort" size="26" style="width:100%" ondblclick="window.location.href='{{ url controller="Products" action="SortAttrCates" }}&parent_id=' + $('#sort option:selected').val()">
            ...
            <div class="layout-right">
                ...
                <div class="box">
                    ...
                    <div class="form">
                        ...
                        <p>
                            <label for="parent_id">选择排序属性项</label>
                            <select id="parent_id" name="parent_id">
                                <option value="0">所有一级属性项</option>
...
{{ /foreach }}
                            ...
                            <input class="ibtn" type="button" value="列出属性项" 
                            onclick="window.location.href='{{ url controller="Products" action="SortAttrCates" }}&parent_id=' + $('#parent_id option:selected').val()" />
                        </p>
