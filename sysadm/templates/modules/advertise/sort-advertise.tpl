...
{{ webcontrol type='Position' name='position' column='栏目管理' position='广告排序' footprint='yes' }}
...
<script type="text/javascript" src="/sysadm/js/sortselect.js"></script>
    ...
    <div class="layout clearfix mt">
        ...
        <form id="sortform" name="sortform" action="{{ url controller='Advertise' action='SaveSortAdv' }}" method="post">
            ...
            <div class="layout-left">
                ...
                <div class="box">
                    ...
                    <div class="form">
                        ...
                        {{ section name=advertise loop=$advertises }}
                            <option value="{{ $advertises[advertise].adv_id}}">{{ $smarty.section.advertise.iteration }}.{{ $advertises[advertise].title}}</option>
                        {{ /section }}
                        </select>
                    </div>
                </div>
